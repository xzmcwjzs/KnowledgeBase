    ...
    if (diseaseCode != "") {
        $.ajax({
            ...
            success: function (data) {
                ...
                strHTML += '<div style="margin:5px 0px;text-align:center;"><span style="font-weight:bold;">'+nameList+'</div>';
                for (i = 0; i < jsonRes.length; i++) {
                    count = jsonRes.length;
                    strHTML += '<div id="div' + jsonRes[i].VModulesId + '">' +
                               //'<div style="padding-top:10px;"><span style="font-size:20pt;font-weight:bold;">' + jsonRes[i].VModulesName + '</span></div>' +
